...
class WeeklyAdapter(
    private val taskList: MutableList<WeeklyDataClass>,
    private val listener: OnTaskCheckedChangeListener
) : RecyclerView.Adapter<WeeklyAdapter.TaskViewHolder>() {
    ...
    interface OnTaskCheckedChangeListener {
        fun onTaskCheckedChanged(task: WeeklyDataClass, isChecked: Boolean)
    }
}
