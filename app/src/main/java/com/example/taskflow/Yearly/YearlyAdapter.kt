...
class YearlyAdapter(
    private val taskList: MutableList<YearlyDataClass>,
    private val listener: OnTaskCheckedChangeListener
) : RecyclerView.Adapter<YearlyAdapter.TaskViewHolder>() {
    ...
    interface OnTaskCheckedChangeListener {
        fun onTaskCheckedChanged(task: YearlyDataClass, isChecked: Boolean)
    }
}
